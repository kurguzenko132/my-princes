...
const introSteps = [
  {
    ...
    title: 'Привет, Вика 💛',
    text: 'Я сделал для тебя кое-что личное. Маленькое место, где можно спокойно учиться парковаться.',
    button: 'Дальше',
    icon: Heart
  },
  {
    ...
    text: 'Чтобы парковка не казалась чем-то нервным и непонятным. Здесь можно тренироваться спокойно, без спешки и без чужих комментариев.',
    button: 'Дальше',
    icon: Gift
  },
  {
    ...
    text: 'Можно ошибаться, начинать заново, включать подсказки и постепенно понимать, как машина двигается.',
    button: 'Дальше',
    icon: ShieldCheck
  },
  {
    ...
    text: 'Это траектория, габариты, скорость и понимание момента, когда нужно повернуть руль.',
    button: 'Дальше',
    icon: Route
  },
  {
    ...
    text: 'В симуляторе машина ощущается как не маленький автомобиль: нужно учитывать длину, передний и задний свес, радиус поворота.',
    button: 'Дальше',
    icon: Car
  },
  {
    ...
    text: 'Короткие уроки объяснят, как машина поворачивает, почему задом парковаться точнее и как видеть габариты заранее.',
    button: 'Дальше',
    icon: Gauge
  },
  {
    eyebrow: 'Vika Parking',
    title: 'Твой личный тренажёр парковки 🚗',
    text: 'Вид сверху, точная траектория, машина-призрак, подсказки и реальные ситуации: магазин, двор, бордюр и тесное место.',
